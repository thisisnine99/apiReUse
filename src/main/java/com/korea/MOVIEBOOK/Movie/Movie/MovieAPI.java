...
public class MovieAPI {
    ...
    public void movieDb(String date) {
        ...
        try {
                ...
                for(Map map : dboxoffList) {
                    ...
                    String director = movieDetail((String)map.get("movieCd"), date);
                    kmdb((String)map.get("movieNm"), director);
                    this.movieDailyService.add(Long.parseLong((String)map.get("rank")), (String)map.get("movieNm"),Long.parseLong((String)map.get("audiAcc")),date , director);
                }
    ...
    public void kmdb(String movieNm, String director) {
        ...
        try {
                ...
                UriComponents uri = UriComponentsBuilder.fromHttpUrl(url + key +"&detail=Y&title=" + movieNm+ "&director="+ director).build();
            ...
            this.movieDailyService.addKmdb(plotText, company,poster,director);
    ...
    public String movieDetail(String code, String date) {
        ...
        try {
            ...
            this.movieDailyService.addDeail(date, actors, runtime, genre, releaseDate, viewingRating, director);
            return director;
